...
class MemoryRuntime private constructor(
    ...
    fun startWarmup(
        ...
        runtimeScope.launch(Dispatchers.IO) {
            try {
                ...
                ready = true
                println("[Vicky] 记忆系统已就绪（topK: ${memoryConfig.memoryTopK}, tokenBudget: ${memoryConfig.memoryTokenBudget}）")
    ...
    companion object {
        fun create(
            ...
            val embedding = memoryConfig.embedding ?: return MemoryRuntime(null, null, null, null, null, null)
